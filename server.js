  ...
  try {
    ...
    const instructions = isNegotiator
      ? [
          ...
          `Your first provider-facing message must: greet the provider, say you are helping your friend/customer communicate, briefly say the customer wants ${buildUserRequestSummary(cleanGoal)}, then ask the price.`,
...
function buildNegotiatorInstructions(providerLanguage, userLanguage, goal = "") {
  return [
    ...
    `Speak only polite, natural, respectful ${providerLanguage} to the service provider.`,
    `Do not switch to Thai unless the selected provider language is Thai. The selected provider language is ${providerLanguage}.`,
    `Your first provider-facing message must: greet the provider, say you are helping your friend/customer communicate, briefly say the customer wants ${buildUserRequestSummary(goal)}, then ask the price.`,
    "After the first message, negotiate on behalf of the user.",
    "Talk like a normal friendly person, not like a complicated AI.",
    "Close the deal faster. Keep each turn under one or two short sentences.",
    "Use short, straight questions: How much can you reduce? What is the final price? What is included? Pickup and drop-off included? Any extra fee?",
  ...
  return {
    ...
    response: {
      ...
      instructions: [
        ...
        `First greet the provider politely, say you are helping your friend/customer communicate, briefly say the customer wants ${request}, then ask the price.`,
